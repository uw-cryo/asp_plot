...
For planetary DEMs, altimetry data must be requested separately using [`request_planetary_altimetry`](request_planetary_altimetry.md), then passed via `--altimetry-csv`:
