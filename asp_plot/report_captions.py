...
EARTH_ALIGNMENT_DESCRIPTION = (
    ...
    "than a broad misfit. NMAD / RMSE are reported by ASP >= "
    "3.7.0 and omitted for older pc_align logs.\n"
...
def planetary_alignment_description(instrument):
    return (
        ...
        f"than a broad misfit. NMAD / RMSE are reported by ASP >= "
        f"3.7.0 and omitted for older pc_align logs.\n"
